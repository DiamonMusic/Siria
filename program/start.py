...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/8543352551cc57ba63756.jpg",
        caption=f"""Programmer [SَٰaٌِlٰaٰٰH Sٍَiِ𝖱ٍiٰa](https://t.me/BK_ZT) 𖡼\nᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼\nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("Sَoٰuِِ𝖱ٰcٌe ٰDٍِiٰaِmٓoِٰ𝗇ٰٰDِِ", url=f"https://t.me/CR_T2"),
            ],
            [
                InlineKeyboardButton(
                    "SَٰaٌِlٰaٰٰH Sٍَiِ𝖱ٍiٰa .", url=f"https://t.me/Salah_Siria"
                ),
            ],
            [
                InlineKeyboardButton("ضيفني في جروبك ➕", url=f"https://t.me/{BOT_USERNAME}?startgroup=true"),
            ]
         ]
     )
  )
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("Sَoٰuِِ𝖱ٰcٌe ٰDٍِiٰaِmٓoِٰ𝗇ٰٰDِِ", url=f"https://t.me/BK_ZT"),
            ],
            [
                InlineKeyboardButton(
